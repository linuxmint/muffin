 ...
 * @META_LATER_CALC_SHOWING: used by Muffin to compute which windows should be mapped
 * @META_LATER_CHECK_FULLSCREEN: used by Muffin to see if there's a fullscreen window
 * @META_LATER_SYNC_STACK: used by Muffin to send it's idea of the stacking order to the server
