...
gboolean meta_window_is_titlebar_hide (MetaWindow *window);
void meta_window_set_hide_titlebar (MetaWindow *window, gboolean hide);
void meta_window_set_hide_titlebar_when_maximized (MetaWindow *window, gboolean hide);
