 ...
 * @plugin: A #MetaPlugin
 *
 * This function returns all of the #MetaWindowActor objects referenced by Muffin, including
 * override-redirect windows.  The returned list is a snapshot of Muffin's current
