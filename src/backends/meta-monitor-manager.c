                                               ...
                                               MetaMonitorsConfig *config)
{
  ...
  /*
   * Re-find the primary after sorting: it keeps its is_primary flag, so
   * just walk the (now sorted) list.
   */
  primary_logical_monitor = NULL;
  for (l = logical_monitors; l; l = l->next)
    {
      MetaLogicalMonitor *lm = l->data;

      if (meta_logical_monitor_is_primary (lm))
        {
          primary_logical_monitor = lm;
          break;
        }
    }
                                                       ...
                                                       MetaMonitorsConfig *config)
{
  ...
  /*
   * Re-find the primary after sorting.
   */
  primary_logical_monitor = NULL;
  for (l = logical_monitors; l; l = l->next)
    {
