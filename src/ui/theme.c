  ...
  while (n_left > 0 || n_right > 0)
    {
      ...
      space_used_by_buttons += layout->button_margin.left * n_left;
      space_used_by_buttons += button_width * n_left;
      space_used_by_buttons += layout->button_margin.right * n_left;
      space_used_by_buttons += (button_width * 0.75) * n_left_spacers;
      space_used_by_buttons += layout->titlebar_spacing * MAX (n_left - 1, 0);

      space_used_by_buttons += layout->button_margin.left * n_right;
      space_used_by_buttons += button_width * n_right;
      space_used_by_buttons += layout->button_margin.right * n_right;
