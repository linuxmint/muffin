...
/* This is temporary because of code removed by https://github.com/linuxmint/muffin/commit/e252272477c68cd8584eb590a2c608012fe17621 */
#define MINI_ICON_WIDTH 16
...
meta_frame_layout_new  (void)
{
  ...
  layout->icon_size = MINI_ICON_WIDTH;
  ...
  while (n_left > 0 || n_right > 0)
    {
      ...
      space_used_by_buttons += layout->button_margin.left * n_left * scale;
      space_used_by_buttons += button_width * n_left;
      space_used_by_buttons += layout->button_margin.right * n_left * scale;
      space_used_by_buttons += (button_width * 0.75) * n_left_spacers;
      space_used_by_buttons += layout->titlebar_spacing * scale * MAX (n_left - 1, 0);

      space_used_by_buttons += layout->button_margin.left * n_right * scale;
      space_used_by_buttons += button_width * n_right;
      space_used_by_buttons += layout->button_margin.right * n_right * scale;
  ...
  while (i >= 0)
    {
      ...
      x = rect->visible.x - layout->button_margin.left;
