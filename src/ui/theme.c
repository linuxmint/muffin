      ...
      if (button_rect.width > 0 && button_rect.height > 0)
        {
          ...
          switch (button_type)
            ...
            case META_BUTTON_TYPE_MAXIMIZE:
               if (flags & META_FRAME_MAXIMIZED)
                 icon_name = "xapp-window-restore-symbolic";
               else
                 icon_name = "xapp-window-maximize-symbolic";
               break;
            case META_BUTTON_TYPE_MINIMIZE:
               icon_name = "xapp-window-minimize-symbolic";
               break;
            case META_BUTTON_TYPE_MENU:
               icon_name = "xapp-open-menu-symbolic";
               break;
            default:
               icon_name = NULL;
               break;
                           ...
                           MetaFrameFlags  flags)
{
  ...
  else if (flags & META_FRAME_TILED_ANY)
    class_name = "tiled";
